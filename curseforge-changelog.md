...
- Fix Penetration: thrown tridents now really deal the extra `1.5 + 0.5 x (level - 1)` damage. The target's invulnerability ticks were discarding the bonus hit entirely.
